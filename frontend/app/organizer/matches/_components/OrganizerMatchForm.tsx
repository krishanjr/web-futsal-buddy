...
import { ActionResult } from "@/lib/actions/organizer-match-actions";
import { AdminMatch } from "@/lib/types";

const initialState: ActionResult = { success: true };

export default function OrganizerMatchForm({
  match,
  action,
}: {
  match?: AdminMatch;
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4 max-w-lg">
      ...
      <div className="flex items-center gap-3 mt-1">
        ...
        <Link href="/organizer/matches" className="text-sm text-gray-500 hover:text-gray-700">
          Cancel
        </Link>
      </div>
    </form>
